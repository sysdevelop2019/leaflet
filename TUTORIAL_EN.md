...
* Multi-core support. Leaf utilize its modules and [leaf/go](https://gitee.com/aarlin/leaflet/tree/master/go) to make use of CPU resouces at maximum while avoiding varieties of side effects may be caused.
...
* Modules communicate with one another via a light weight RPC channel([leaf/chanrpc](https://gitee.com/aarlin/leaflet/tree/master/chanrpc))
...
import (
    "gitee.com/aarlin/leaflet/network/json"
)
...
More references are at [leaf/go](https://gitee.com/aarlin/leaflet/blob/master/go)。
...
More references are at [leaf/timer](https://gitee.com/aarlin/leaflet/blob/master/timer)。
...
More references are at [leaf/log](https://gitee.com/aarlin/leaflet/blob/master/log).

### Leaf recordfile

Leaf recordfile is formatted in CSV([Example](https://gitee.com/aarlin/leaflet/blob/master/recordfile/test.txt)). recordfile is to manage the configuration for game. The usage of recordfile in LeafServer is quite simple:
...
Refer to [leaf/recordfile](https://gitee.com/aarlin/leaflet/blob/master/recordfile) for more details.

Learn more
----------

More references are at Wiki [https://gitee.com/aarlin/leaflet/wiki](https://gitee.com/aarlin/leaflet/wiki)
